...
public class ModifierActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boutonModif=(Button) findViewById(R.id.buttonValiderModif);
        ...
        txtDateE = (EditText) findViewById(R.id.editTextDate);
        ...
        txtDateE.setText(lesVisiteurs.get(0).getDateEmbauche());
        ...
        boutonModif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Visiteur leNouveauVisiteur = new Visiteur(resId,resNom, resPrenom, resLogin,resMdp,resAdresse, resCP, resVille, resDateE);

                String result = unVisiteurDAO.modifierVisiteur(leNouveauVisiteur,resId);
    ...
    public void actualiser(int position){
        ...
        txtDateE.setText(lesVisiteurs.get(position).getDateEmbauche());
    }
}